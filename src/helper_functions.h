...
// Adding the multivariate gaussian function to the helper functions 

inline double calculateWeightsMultiVarGauss(double sig_x,double sig_y, double x_obs,double y_obs,double mu_x,double mu_y){
